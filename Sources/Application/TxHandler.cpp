...
typedef HRESULT (*SETDILINTERFACEPTRUDS)(void* ptrDILIntrf);
...
SETDILINTERFACEPTRUDS       pfSetDILInterfacePtrUDS;	   
...
void CTxHandler::vloadFuncPtrAddress()
{
	...
	pfSetDILInterfacePtrUDS				= (SETDILINTERFACEPTRUDS)GetProcAddress(m_hTxHandle, "TX_vSetDILInterfacePtrUDS");
...
/*******************************************************************************
  ...
  Author(s)      : ArunKumar K
  Date Created   : 03.08.2010
  Modifications  : Sánchez A 20.03.2013- Modified the function to set the
				   DIL interface Pointer to	UDS_Protocol Project
*******************************************************************************/
void CTxHandler::vSetDILInterfacePtr(void* ptrDILIntrf)
{
	...
	if(pfSetDILInterfacePtrUDS != NULL)
    {
        pfSetDILInterfacePtrUDS(ptrDILIntrf);
    }
	HRESULT Temp =	TX_vSetDILInterfacePtrUDS(ptrDILIntrf);
